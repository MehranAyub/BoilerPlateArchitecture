    ...
    getProperties(event?: LazyLoadEvent) {
        ...
        this._propertiesServiceProxy
            .getAll(
                ...
                this.maxWholeSalePriceFilter == null
                    ? this.maxWholeSalePriceFilterEmpty
                    : this.maxWholeSalePriceFilter,
                this.minWholeSalePriceFilter == null
                    ? this.minWholeSalePriceFilterEmpty
                    : this.minWholeSalePriceFilter,
                this.maxEstimatedARVFilter == null
                    ? this.maxEstimatedARVFilterEmpty
                    : this.maxEstimatedARVFilter,
                this.minEstimatedARVFilter == null
                    ? this.minEstimatedARVFilterEmpty
                    : this.minEstimatedARVFilter,
                this.maxEstimatedRehabFilter == null
                    ? this.maxEstimatedRehabFilterEmpty
                    : this.maxEstimatedRehabFilter,
                this.minEstimatedRehabFilter == null
                    ? this.minEstimatedRehabFilterEmpty
                    : this.minEstimatedRehabFilter,
                this.viewingDescriptionFilter,
                this.maxEMDRequirementFilter == null
                    ? this.maxEMDRequirementFilterEmpty
                    : this.maxEMDRequirementFilter,
                this.minEMDRequirementFilter == null
                    ? this.minEMDRequirementFilterEmpty
                    : this.minEMDRequirementFilter,
