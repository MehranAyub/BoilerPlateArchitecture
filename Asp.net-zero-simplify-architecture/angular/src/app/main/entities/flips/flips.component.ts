...
export class FlipsComponent extends AppComponentBase {
    @ViewChild("createOrEditFlipModal", { static: true })
    createOrEditFlipModal: CreateOrEditFlipModalComponent;
    @ViewChild("viewFlipModalComponent", { static: true })
    viewFlipModal: ViewFlipModalComponent;
    ...
    getFlips(event?: LazyLoadEvent) {
        ...
        this._flipsServiceProxy
            .getAll(
                ...
                this.maxPricePurchasedFilter == null
                    ? this.maxPricePurchasedFilterEmpty
                    : this.maxPricePurchasedFilter,
                this.minPricePurchasedFilter == null
                    ? this.minPricePurchasedFilterEmpty
                    : this.minPricePurchasedFilter,
                this.maxAmountRehabFilter == null
                    ? this.maxAmountRehabFilterEmpty
                    : this.maxAmountRehabFilter,
                this.minAmountRehabFilter == null
                    ? this.minAmountRehabFilterEmpty
                    : this.minAmountRehabFilter,
                this.maxDateSoldFilter,
                this.minDateSoldFilter,
                this.maxAmountSoldFilter == null
                    ? this.maxAmountSoldFilterEmpty
                    : this.maxAmountSoldFilter,
                this.minAmountSoldFilter == null
                    ? this.minAmountSoldFilterEmpty
                    : this.minAmountSoldFilter,
    ...
    deleteFlip(flip: FlipDto): void {
        this.message.confirm("", (isConfirmed) => {
            if (isConfirmed) {
                this._flipsServiceProxy.delete(flip.id).subscribe(() => {
                    this.reloadPage();
