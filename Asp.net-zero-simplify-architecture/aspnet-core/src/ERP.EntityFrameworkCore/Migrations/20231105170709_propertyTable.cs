        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertySpecs = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: false),
                    WholeSalePrice = table.Column<int>(nullable: false),
                    EstimatedARV = table.Column<int>(nullable: true),
                    EstimatedRehab = table.Column<int>(nullable: true),
                    ViewingDescription = table.Column<string>(nullable: true),
                    EMDRequirement = table.Column<int>(nullable: false),
                    ViewingContact = table.Column<string>(nullable: true),
                    OfferContact = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
